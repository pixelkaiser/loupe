...
| --- | --- | --- | --- | --- |
| [README.md](../README.md) | users · agents | pitch, quickstart, CLI flags, `.loupe.json` overview | verify-knowledge (links) · `task check` | 2026-09-17 |
...
| [docs/guide.md](guide.md) | users | what loupe does, install, running a review, CLI flag table, logging | verify-knowledge (links) | 2026-09-17 |
...
| [docs/how-it-works/README.md](how-it-works/README.md) | all | pipeline walkthrough with Mermaid diagrams: context, first-vs-incremental review, the review run, GitHub objects, chat, triggers; GitLab framing note | verify-knowledge (links) | 2026-09-21 |
